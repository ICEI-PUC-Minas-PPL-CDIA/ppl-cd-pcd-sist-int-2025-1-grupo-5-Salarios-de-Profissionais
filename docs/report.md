- [Os fatores que influenciam os salários dos profissionais de dados no Brasil.](#os-fatores-que-influenciam-os-sal-rios-dos-profissionais-de-dados-no-brasil)
  * [Introdução](#introdu--o)
  * [Contextualização](#contextualiza--o)
  * [Problema](#problema)
  * [Objetivo geral](#objetivo-geral)
  * [Objetivos específicos](#objetivos-espec-ficos)
  * [Justificativas](#justificativas)
  * [Público alvo](#p-blico-alvo)
  * [Análise exploratórida dos dados.](#an-lise-explorat-rida-dos-dados)
  * [Dicionário de Dados](#dicion-rio-de-dados)
  * [Descrição de dados :bar_chart:](#descri--o-de-dados--bar-chart-)
    + [State of Data](#state-of-data)
    + [Faixa Salarial](#faixa-salarial)
    + [Salário Médio (Coluna calculada baseada na coluna faixa salarial da tabela original)](#sal-rio-m-dio--coluna-calculada-baseada-na-coluna-faixa-salarial-da-tabela-original-)
      - [Obs.: Para fins de visualização, a Coluna salário médio foi criada.](#obs--para-fins-de-visualiza--o--a-coluna-sal-rio-m-dio-foi-criada)
    + [Média salárial por UF](#m-dia-sal-rial-por-uf)
    + [Idade](#idade)
    + [Sexo ou Gênero](#sexo-ou-g-nero)
    + [Raça ou Etnia](#ra-a-ou-etnia)
    + [Nível de Ensino](#n-vel-de-ensino)
    + [UF](#uf)
    + [Quantidade de profissionais de Dados relacionando Gêneros por Uf](#quantidade-de-profissionais-de-dados-relacionando-g-neros-por-uf)
    + [Distribuição da média salarial por gênero por UF](#distribui--o-da-m-dia-salarial-por-g-nero-por-uf)
    + [Média salarial por Gênero](#m-dia-salarial-por-g-nero)
    + [Média salarial por Cor/Raça/Etnia](#m-dia-salarial-por-cor-ra-a-etnia)
    + [Cargo Atual](#cargo-atual)
    + [Média salarial por Cargo na área de Ciência de Dados](#m-dia-salarial-por-cargo-na--rea-de-ci-ncia-de-dados)
    + [Média salarial por Ferramenta/Plataforma Utilizada](#m-dia-salarial-por-ferramenta-plataforma-utilizada)
    + [Média salarail por linguagem de programação Utilizada](#m-dia-salarail-por-linguagem-de-programa--o-utilizada)
    + [Média salarial por setores de Atuação](#m-dia-salarial-por-setores-de-atua--o)
    + [Número de funcionários da empresa que trabalha](#n-mero-de-funcion-rios-da-empresa-que-trabalha)
    + [Nível](#n-vel)
    + [Média salarial por Nivel de experiência.](#m-dia-salarial-por-nivel-de-experi-ncia)
    + [Tempo de experiência na área de dados](#tempo-de-experi-ncia-na--rea-de-dados)
  * [Base Auxiliares](#base-auxiliares)
    + [IDH 2021 por UF](#idh-2021-por-uf)
    + [PIB 2021 por UF](#pib-2021-por-uf)
- [🧪 Preparação dos dados](#---prepara--o-dos-dados)
    + [1. Seleção dos Atributos para a **Hipótese 1:**](#1-sele--o-dos-atributos-para-a---hip-tese-1---)
    + [2. Tratamento dos Valores Faltantes ou Omissos (NaN) **Hipótese 1:**](#2-tratamento-dos-valores-faltantes-ou-omissos--nan----hip-tese-1---)
    + [Remoção de Linhas](#remo--o-de-linhas)
    + [Substituição por Zero](#substitui--o-por-zero)
    + [3. Tratamento dos Valores Inconsistentes **Hipótese 1:**](#3-tratamento-dos-valores-inconsistentes---hip-tese-1---)
    + [Remoção de Categorias Irrelevantes](#remo--o-de-categorias-irrelevantes)
    + [Unificação de Categorias](#unifica--o-de-categorias)
    + [Agrupamento de Categorias Raras](#agrupamento-de-categorias-raras)
    + [4. Conversão de Dados e Engenharia de Atributos **Hipótese 1:**](#4-convers-o-de-dados-e-engenharia-de-atributos---hip-tese-1---)
    + [Criação da Variável Alvo (`Salario_target`)](#cria--o-da-vari-vel-alvo---salario-target--)
    + [Codificação Ordinal](#codifica--o-ordinal)
    + [Engenharia de Features de Habilidades](#engenharia-de-features-de-habilidades)
    + [Discretização de Variável Numérica](#discretiza--o-de-vari-vel-num-rica)
    + [Conversão para Formato Binário (One-Hot Encoding)](#convers-o-para-formato-bin-rio--one-hot-encoding-)
    + [Observação dados IDH e PIB](#observa--o-dados-idh-e-pib)
    + [Produto Interno Bruto (PIB)](#produto-interno-bruto--pib-)
    + [Índice de Desenvolvimento Humano (IDH)](#-ndice-de-desenvolvimento-humano--idh-)
    + [1. Seleção dos Atributos para a **Hipótese 3:**](#1-sele--o-dos-atributos-para-a---hip-tese-3---)
    + [2. Tratamento dos Valores Faltantes ou Omissos (NaN) **Hipótese 3:**](#2-tratamento-dos-valores-faltantes-ou-omissos--nan----hip-tese-3---)
  * [Preparação dos dados específica para **Hipótese 4:**](#prepara--o-dos-dados-espec-fica-para---hip-tese-4---)
  * [Tratamento de Valores Ausentes](#tratamento-de-valores-ausentes)
  * [Codificação de Variáveis](#codifica--o-de-vari-veis)
  * [Verificação de Qualidade](#verifica--o-de-qualidade)
  * [Seleção de Variáveis](#sele--o-de-vari-veis)
- [Indução de modelos 🧠](#indu--o-de-modelos---)
  * [Hipótese 1 - É possível prever a faixa salarial de um profissional com base nos indicadores socioeconômicos (PIB e IDH) do estado onde ele trabalha?](#hip-tese-1-----poss-vel-prever-a-faixa-salarial-de-um-profissional-com-base-nos-indicadores-socioecon-micos--pib-e-idh--do-estado-onde-ele-trabalha-)
- [Modelo 1](#modelo-1)
  * [Árvore de Decisão 🌳](#-rvore-de-decis-o---)
    ...
    + [Parâmetros do Modelo](#par-metros-do-modelo)
  * [Fluxo de Processamento](#fluxo-de-processamento)
- [Resultado 🎯](#resultado---)
    + [Resultados obtidos com o Modelo 1: Árvore de Decisão](#resultados-obtidos-com-o-modelo-1---rvore-de-decis-o)
      - [Matriz de Confusão](#matriz-de-confus-o)
      - [Métricas de Performance (Precisão, Revocação e F-Measure)](#m-tricas-de-performance--precis-o--revoca--o-e-f-measure-)
    + [Interpretação do Modelo 1: Árvore de Decisão](#interpreta--o-do-modelo-1---rvore-de-decis-o)
      - [Parâmetros do Modelo Obtido](#par-metros-do-modelo-obtido)
      - [Regras de "Raciocínio" do Modelo](#regras-de--racioc-nio--do-modelo)
      - [Importância das Features](#import-ncia-das-features)
- [Modelo 2](#modelo-2)
  * [Hipótese 1 - É possível prever a faixa salarial de um profissional com base nos indicadores socioeconômicos (PIB e IDH) do estado onde ele trabalha?](#hip-tese-1-----poss-vel-prever-a-faixa-salarial-de-um-profissional-com-base-nos-indicadores-socioecon-micos--pib-e-idh--do-estado-onde-ele-trabalha--1)
  * [K-Vizinhos Mais Próximos (KNN) ⚙️](#k-vizinhos-mais-pr-ximos--knn----)
    + [Justificativa da Escolha](#justificativa-da-escolha-1)
  * [Fluxo de Processamento](#fluxo-de-processamento-1)
- [Resultado 🎯](#resultado----1)
  * [Resultados obtidos com o Modelo 2: K-Vizinhos Mais Próximos (KNN)](#resultados-obtidos-com-o-modelo-2--k-vizinhos-mais-pr-ximos--knn-)
      - [Matriz de Confusão](#matriz-de-confus-o-1)
      - [Métricas de Performance (Precisão, Revocação e F-Measure)](#m-tricas-de-performance--precis-o--revoca--o-e-f-measure--1)
    + [Interpretação do Modelo 2: K-Vizinhos Mais Próximos (KNN)](#interpreta--o-do-modelo-2--k-vizinhos-mais-pr-ximos--knn-)
      - [Parâmetros do Modelo Obtido](#par-metros-do-modelo-obtido-1)
      - [Regras de "Raciocínio" do Modelo](#regras-de--racioc-nio--do-modelo-1)
      - [Importância das Features](#import-ncia-das-features-1)
- [Análise Comparativa dos Modelos](#an-lise-comparativa-dos-modelos)
  * [Hipótese 1](#hip-tese-1)
    + [Comparativo de Modelos - Árvore de Decisão vs KNN](#comparativo-de-modelos----rvore-de-decis-o-vs-knn)
    + [📊 Acurácia Geral](#---acur-cia-geral)
    + [🔍 Comparativo por Classe](#---comparativo-por-classe)
    + [Classe 1 (Faixa Inferior)](#classe-1--faixa-inferior-)
    + [Classe 2 (Faixa Média)](#classe-2--faixa-m-dia-)
    + [Classe 3 (Faixa Superior)](#classe-3--faixa-superior-)
    + [⚖️ Overfitting/Generalização](#---overfitting-generaliza--o)
    + [🏆 Observações](#---observa--es)
    + [Similaridade de Performance](#similaridade-de-performance)
    + [Escolha do Modelo](#escolha-do-modelo)
  * [Cenários de Uso: Qual Modelo se Sairia Melhor?](#cen-rios-de-uso--qual-modelo-se-sairia-melhor-)
    + [A Árvore de Decisão seria superior para...](#a--rvore-de-decis-o-seria-superior-para)
    + [O KNN seria superior para...](#o-knn-seria-superior-para)
- [Conclusão 💡](#conclus-o---)
- [Observações Pessoais DIEGO](#observa--es-pessoais-diego)
...
- [Hipótese  – Características demográficas e profissionais influenciam a faixa salarial?](#hip-tese----caracter-sticas-demogr-ficas-e-profissionais-influenciam-a-faixa-salarial-)
- [Modelo 1 – XGBoost](#modelo-1---xgboost)
  * [Indução do Modelo 1](#indu--o-do-modelo-1)
    + [Parâmetros utilizados:](#par-metros-utilizados-)
  * [Resultado Modelo 1](#resultado-modelo-1)
    + [Acurácia: **78,63%** (Teste)](#acur-cia----78-63-----teste-)
    + [Acurácia: **85,40%** (Treino)](#acur-cia----85-40-----treino-)
- [Modelo 2 – Random Forest](#modelo-2---random-forest)
  * [Indução do Modelo 2](#indu--o-do-modelo-2)
    + [Parâmetros utilizados:](#par-metros-utilizados--1)
  * [Resultado Modelo 2](#resultado-modelo-2)
    + [Acurácia: **74,54%** (Teste)](#acur-cia----74-54-----teste-)
    + [Acurácia: **85,22%** (Treino)](#acur-cia----85-22-----treino-)
- [Análise comparativa dos modelos](#an-lise-comparativa-dos-modelos)
    + [Forças e Fragilidades](#for-as-e-fragilidades)
    + [Exemplos de uso ideal:](#exemplos-de-uso-ideal-)
- [Conclusão](#conclus-o)
  * [No contexto prático, a escolha entre XGBoost e Random Forest dependerá do equilíbrio entre performance e interpretabilidade exigido pela aplicação.](#no-contexto-pr-tico--a-escolha-entre-xgboost-e-random-forest-depender--do-equil-brio-entre-performance-e-interpretabilidade-exigido-pela-aplica--o)
  * [Conclusão](#conclus-o-1)
    + [Implicações para o Mercado](#implica--es-para-o-mercado)
    + [Próximos Passos Recomendados](#pr-ximos-passos-recomendados)
